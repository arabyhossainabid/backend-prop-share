...
const deleteCategory = async (categoryId: string) => {
    ...
    if (hasProperties > 0) {
        throw new AppError(status.BAD_REQUEST, 'Cannot delete category with associated properties');
    }
...
const updatePropertyFeatured = async (propertyId: string, isFeatured: boolean) => {
